...
var admin = __webpack_require__(/*! ../js/admin */ "./resources/js/admin.js");
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (event) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); //to get the data of the pizza for which the add button was clicked
...
if (order) {
  socket.emit('join', "order_".concat(order._id)); //we are emitting the orderid to the backend socket connection ir.server.js file
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //to copy the order
